...
export default function CallToAction({ actionText, actionComponent, actionProps, onAction, buttonText, buttonComponent, buttonProps, ...props }) {
        ...
        <Center px="5" py="8" {...props}>
            <Flex w={{ sm: "full", md: "2/3" }} flexDir={{ sm: "column", md: "row" }} alignItems={{ md: "center" }}>
                {actionComponent ? actionComponent :
                    <Heading pr="6" fontWeight="medium" {...actionProps}
